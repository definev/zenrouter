  ...
  Widget build(AppCoordinator coordinator, BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        leading: BackButton(
          onPressed: () async {
            if (await coordinator.embeddedCoordinator.tryPop() == true) return;
            coordinator.tryPop();
          },
        ),
...
abstract class EmbeddedProxyRoute extends AppRoute
    with
        ProxyRoute<AppRoute>,
        CoordinatorProxyRoute<AppRoute, EmbeddedAppRoute> {
  @override
  Type get layout => EmbeddedShellRoute;

  @override
  EmbeddedCoordinator resolveProxyCoordinator(ProxyPath<AppRoute> path) =>
...
class OpenEmbeddedHomeRoute extends EmbeddedProxyRoute {
  @override
  final EmbeddedAppRoute proxyRoute = EmbeddedHomeRoute();
...
class OpenEmbeddedDetailRoute extends EmbeddedProxyRoute {
  ...
  @override
  late final EmbeddedAppRoute proxyRoute = EmbeddedDetailRoute(id);
...
class OpenEmbeddedSettingsRoute extends EmbeddedProxyRoute {
  ...
  @override
  final EmbeddedAppRoute proxyRoute = EmbeddedSettingsRoute();
}
