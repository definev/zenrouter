...
class NavigationPath<T extends RouteTarget> extends StackPath<T>
  ...
  factory NavigationPath.createWith({
    ...
    assert(
      ...
      'NavigationPath.createWith received a Coordinator that is itself a RouteModule.\n'
      ...
      '  NavigationPath.createWith(label: "myPath", coordinator: coordinator);\n\n'
    ...
    return NavigationPath._(label, stack ?? [], coordinator);
  }
