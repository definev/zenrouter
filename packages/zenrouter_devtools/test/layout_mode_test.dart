...
void main() {
  group('DevTools Layout Modes', () {
    ...
    testWidgets('Row layout mode places App and DevTools side-by-side and allows resizing', (
      tester,
    ) async {
      tester.view.devicePixelRatio = 1;
      tester.view.physicalSize = const Size(1000, 800);
      ...
      expect(resizedPanelSize.width, closeTo(initialPanelSize.width + 100, 1));
    ...
    testWidgets('Column layout mode places App and DevTools vertically and allows resizing', (
      tester,
    ) async {
      tester.view.devicePixelRatio = 1;
      tester.view.physicalSize = const Size(1000, 800);
      ...
      expect(resizedPanelSize.height, closeTo(initialPanelSize.height + 80, 1));
    ...
    testWidgets('Header tool menu dynamically switches between Stack, Row, and Column', (
      tester,
    ) async {
      tester.view.devicePixelRatio = 1;
      tester.view.physicalSize = const Size(1000, 800);
      ...
      expect(
        find.byKey(const ValueKey('zenrouter-debug-panel-column-resize-handle')),
        findsOneWidget,
      );
      expect(
        find.byKey(const ValueKey('zenrouter-debug-tool-menu-popup')),
...
final class _LayoutTestRoute extends RouteTarget with RouteUnique {
  ...
  @override
  Widget build(covariant _LayoutTestCoordinator coordinator, BuildContext context) {
