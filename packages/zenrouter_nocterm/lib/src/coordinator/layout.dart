...
import 'package:zenrouter_nocterm/src/mixin/transition.dart';
...
import 'package:zenrouter_nocterm/src/path/stack.dart';
...
final kDefaultLayoutBuilderTable =
    Map.unmodifiable(<PathKey, RouteLayoutBuilder>{
      ...
      IndexedStackPath.key: (coordinator, path, layout) {
